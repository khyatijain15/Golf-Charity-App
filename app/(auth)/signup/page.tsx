    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: '100vh' }}>
      ...
      <div style={{
        ...
        <div className="card-glass" style={{ width: '100%', maxWidth: 400, padding: '40px 36px' }}>
          ...
          <h2 style={{ fontSize: 26, fontWeight: 700, fontFamily: 'var(--font-heading)', marginBottom: 6 }}>Create account</h2>
          <p style={{ color: 'var(--text-secondary)', fontSize: 14, marginBottom: 20 }}>Join the challenge today</p>
